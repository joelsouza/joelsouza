  ...
  return (
    <article className="main">
      ...
      <section className="hero">
        <header>
          <h1>Hi, I&apos;m Joel</h1>
          <p className="subtitle">a passionate full-stack developer from Brazil.</p>
        </header>
      </section>
      <section className='intro'>
          ...
          <p>
            ...
            I&apos;ve running half marathons from time to time and aspiring to run a marathon someday. <br />
          </p>
          <p>
